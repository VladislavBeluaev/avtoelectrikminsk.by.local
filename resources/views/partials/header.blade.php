    ...
    <header role="banner" id="main_header">
        <div class="header-wrapper">
            <div class="header-wrapper__logo">
                <p>
                    <a href="{{route('main')}}"><img src="{{asset('storage/header/logo.png')}}" alt="main_logo"></a>
                </p>
            </div>
            <div class="header-wrapper__mobile-contacts">
                <h2>Автоэлектрик в Минске 24 часа</h2>
                <h2><a href="tel:+375 29 925 80 45">+375 29 925 80 45</a></h2>
                <h2><a href="tel:+375 25 605 81 75">+375 25 605 81 75</a></h2>
            </div>
            ...
            <div class="header-wrapper__social-contacts">
                ...
                <div class="social-contacts__wrapper">
                    ...
                    <p>
                        <a href="viber://chat?number=+375 25 605 81 75"><i class="fab fa-viber"></i></a>
                    </p>
                </div>
